...
async def main() -> None:
    async with client:
        ...
        # 프롬프트 목록 가져오기
        print("prompts on server:".ljust(28), [p.name for p in await client.list_prompts()])
        ...
        show("ask_about_topic".ljust(28), r1)
        ...
        show("generate_code_request".ljust(28), r2)
        ...
        show("roleplay_scenario".ljust(28), r3)
        ...
        show("data_based_prompt".ljust(28), r4)

    print("\nconnected:".ljust(28), client.is_connected())
