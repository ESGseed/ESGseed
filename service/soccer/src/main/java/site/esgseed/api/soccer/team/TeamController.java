package site.esgseed.api.soccer.team;
...
import site.esgseed.api.soccer.common.Messenger;
...
public class TeamController {
    ...
    public Messenger<TeamModel> create(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "생성할 팀 데이터", required = true) @RequestBody TeamModel dto) {
    ...
    public Messenger<TeamModel> update(
            ...
            @PathVariable Long id,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "수정할 팀 데이터", required = true) @RequestBody TeamModel dto) {
