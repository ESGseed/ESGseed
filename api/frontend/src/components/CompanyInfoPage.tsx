...
export function CompanyInfoPage() {
  ...
  const finalCompanyInfo = useReportStore((state: ReportStore) => state.finalCompanyInfo);
  ...
  const updateCompanyInfo = useReportStore((state: ReportStore) => state.updateCompanyInfo);
