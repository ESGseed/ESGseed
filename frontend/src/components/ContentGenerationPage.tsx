...
import { FileText, Sparkles, Send, CheckCircle2, Clock, XCircle, Bot, Save } from 'lucide-react';
    ...
    <div className="min-h-screen bg-background py-8">
      <div className="max-w-[1680px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">TCFD → IFRS S2 Navigator</h1>
          <p className="text-lg text-muted-foreground">
            {!isAnalyzed 
              ? 'AI가 문서를 분석할 수 있도록 텍스트를 입력하세요.'
              : 'AI가 문서 구조를 분석하여 가장 중요한 섹션을 추천합니다.'
            }
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                        ...
                        >
                          <div className="flex items-center justify-between gap-2 mb-1">
                            <span className="font-medium">
                              문장 {idx + 1}{' '}
                              {s.ifrs_titles && s.ifrs_titles.length > 0 && (
          ...
          {/* 오른쪽: 실시간 보고서 문단 프리뷰 */}
          <div className={`lg:col-span-1 space-y-4 ${!isAnalyzed ? 'lg:col-span-4' : ''}`}>
