...
public class ScheduleController {
    ...
    public Messenger<ScheduleDTO> create(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "생성할 일정 데이터", required = true) @RequestBody ScheduleDTO dto) {
    ...
    public Messenger<ScheduleDTO> update(
            ...
            @PathVariable Long id,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "수정할 일정 데이터", required = true) @RequestBody ScheduleDTO dto) {
